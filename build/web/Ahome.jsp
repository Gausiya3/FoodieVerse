...
<html lang="en"><!-- Basic -->
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbars-rs-food">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item  active"><a class="nav-link" href="Ahome.jsp">User List</a></li>
        ...
        <!--==========================================================-->
        <h1 style="margin-left: 600px;margin-top: 30px;margin-bottom: 30px;">Register User</h1>
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th scope="row"><%= rs1.getString(5)%></th>
                    </tr>
